...
# Code School - Java - TestNG - Lesson 2 - Exercise

## Introduction

This code provides the solution to the practical exercise that was given out at the end of Lesson 2.
...
```sh
git clone https://github.com/BS-Code-School-Templates/Java-Web-TestNG-Lesson-2-Exercise.git
```
* Move into the directory that you just cloned by typing
```sh
cd Java-Web-TestNG-Lesson-2-Exercise
```
